...
- the `nearRcolor` function to choose a color by looking in the
neighborhood of one you know  
- the `plotCol` function to see those colors

Show names of colors near deepskyblue - the second arg says what color
space we’re looking in. The dist is euclidean distance in that color
space
...
```
    ...
    ##             0.0            21.4            41.6            48.4            50.0 
    ##   "deepskyblue"  "deepskyblue2"    "turquoise2" "darkturquoise"         "cyan2"
