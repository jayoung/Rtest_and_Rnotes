...
![](table_display_temp_tables/my_tbl_gt.png){#id .class width=60% height=60%}
...
![](table_display_temp_tables/my_tbl_gt_with_long_caption.png){#id .class width=60% height=60%}
...
![](table_display_temp_tables/my_tbl_wrap_colnames_gt.png){#id .class width=60% height=60%}
