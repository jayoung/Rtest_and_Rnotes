...
```{r}
## there are also copies of these functions in useful_functions/multiple_sequence_alignments_functions.R
## if I edit one copy I should edit the other.
## I know there is a better way to handle it than having it in two places but I'm not tidying up for now.
