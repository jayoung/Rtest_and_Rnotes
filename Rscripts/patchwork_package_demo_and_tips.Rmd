...
Maybe we have our plots in a list, perhaps because we generated them using a function. In that case we can use `wrap_plots()` - "it also accepts the same arguments as `plot_layout()`":
