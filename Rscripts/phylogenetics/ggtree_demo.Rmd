...
Now we can plot (this also shows how to use a custom color scheme for the heatmap):
...
Same thing but add x axis scale bar (and heatmap colnames are less ugly now)
